...
Most of these come down to network reality or how nominatim serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

nominatim rate-limits like any public site. nominatim already paces
...
Where a surface is gated, nominatim reads a cookie or token you supply
...
`nominatim`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what nominatim actually did
