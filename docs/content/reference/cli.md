...
```
nominatim <command> [arguments] [flags]
```

Run `nominatim <command> --help` for the full flag list on any command. This
...
per operation you declare in `nominatim/domain.go`.
